...
class Pies {
    ...
    getRatingsPerAnime(anime){
        let data = [];
        data.push({"stars": "Five Star", "rate_count": (parseInt(anime.rate_5) / parseInt (anime.votes) ) * 100, "order" : 1});
        data.push({"stars": "Four Star", "rate_count": (parseInt(anime.rate_4) / parseInt (anime.votes) ) * 100, "order" : 2});
        data.push({"stars": "Three Star", "rate_count": (parseInt(anime.rate_3) / parseInt (anime.votes) ) * 100, "order" : 3} );
        data.push({"stars": "Two Star", "rate_count": (parseInt(anime.rate_2) / parseInt (anime.votes) ) * 100, "order" : 4});
        data.push({"stars": "One Star", "rate_count": (parseInt(anime.rate_1) / parseInt (anime.votes) ) * 100, "order" : 5});
        return data;
    }
    getRatingsPerGenre(genre){
        ...
        data.push({"stars": "Five Star", "rate_count": (total5 /votes ) * 100, "order" : 1});
        data.push({"stars": "Four Star", "rate_count": (total4 /votes ) * 100, "order" : 2});
        data.push({"stars": "Three Star", "rate_count": (total3 /votes ) * 100, "order" : 3} );
        data.push({"stars": "Two Star", "rate_count": (total2 /votes ) * 100, "order" : 4});
        data.push({"stars": "One Star", "rate_count": (total1 /votes ) * 100, "order" : 5});
        return data;
    }
    drawPie(svg, data){
